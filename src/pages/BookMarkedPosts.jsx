...
const BookMarkedPosts = () => {
    ...
    return <>
        {isLoading ? <div className="p-4"><LoadingCard /></div> : <>
            ...
            </div> : <div className="card rounded-2xl mx-5 mt-10 shadow-sm border border-gray-100 px-6 py-10 text-center">
                <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-gray-100 flex items-center justify-center">
                    <i className="fa fa-x text-gray-500 text-xl"></i>
                </div>
                <h3 className="text-lg font-semibold text-main">No bookmarked posts yet !</h3>
