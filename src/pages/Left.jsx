    ...
    return <>
        <div className="space-y-3">
            ...
            <Link to={`/profile/${userData._id}/posts`}>
                ...
                <div className="flex justify-between px-4 py-3 hover:bg-gray-50 cursor-pointer transition">
                    <span className="text-sm text-gray-700">Followers</span>
                    <span className="text-sm font-semibold text-gray-900">{userData.followersCount}</span>
                </div>
                <div className="flex justify-between px-4 py-3 hover:bg-gray-50 cursor-pointer transition border-t border-gray-200">
                    <span className="text-sm text-gray-700">followingCount</span>
                    <span className="text-sm font-semibold text-gray-900">{userData.followingCount}</span>
                </div>
            </div> */}
                </div>
            </Link>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mt-3">
                <nav className="space-y-1 py-2">
                    ...
                    <Link to="/suggestions" className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition rounded-lg mx-1 group">
                        ...
                        <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Sugestions</span>
                    </Link>
